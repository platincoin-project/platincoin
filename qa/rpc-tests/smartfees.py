...
# time signing.
P2SH_1 = "P4t1XhahRpTt4nXHpkjUvYshF5Kbm856XdZe" # P2SH of "OP_1 OP_DROP"
P2SH_2 = "P4tDisaJHVH7Fb5EfGpE3FRTjcVyogaKQRyS" # P2SH of "OP_2 OP_DROP"
...
class EstimateFeeTest(BitcoinTestFramework):
    ...
    def transact_and_mine(self, numblocks, mining_node):
        ...
        for i in range(numblocks):
            ...
            for j in range(random.randrange(100-50+1,100+50)):
