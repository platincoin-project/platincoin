...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Now try a too-large-coinbase script (in platincoin max length is 256 instead of 100 in bitcoin)
        tip(15)
        ...
        # This test is temporary disabled: block is accepted, while CRegTestParams::consensus.fSkipProofOfWorkCheck == true;
        # tip(44)
