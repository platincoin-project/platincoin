...
class AbandonConflictTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        txA = self.nodes[1].sendtoaddress(self.nodes[0].getnewaddress(), Decimal("10"))
        txB = self.nodes[1].sendtoaddress(self.nodes[0].getnewaddress(), Decimal("10"))
        txC = self.nodes[1].sendtoaddress(self.nodes[0].getnewaddress(), Decimal("10"))
