...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        rawmatch = self.nodes[2].createrawtransaction([], {self.nodes[2].getnewaddress():54000000})
        ...
        try:
            ...
            raise AssertionError("Accepted invalid platincoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid platincoin address" in e.error['message'])
        ...
        # result = self.nodes[0].fundrawtransaction(rawtx, {'includeWatching': True })
        # res_dec = self.nodes[1].decoderawtransaction(result["hex"])
