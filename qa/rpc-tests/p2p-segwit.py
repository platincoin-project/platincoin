...
class UTXO(object):
    ...
    def __repr__(self):
        return "UTXO(sha256=%064x n=%i nValue=%i)" % (self.sha256, self.n, self.nValue)
...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_non_witness_transaction(self):
        ...
        tx.vout.append(CTxOut(5999999*COIN, CScript([OP_TRUE])))
        tx.calc_sha256()
        ...
        self.utxo.append(UTXO(tx.sha256, 0, 5999999*COIN))
    ...
    def test_block_relay(self, segwit_activated):
        ...
        # Platincoin: Blocks with nVersion < VB_TOP_BITS are rejected
