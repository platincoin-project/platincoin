...
BOOST_AUTO_TEST_CASE(rpc_convert_values_generatetoaddress)
{
    ...
    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", boost::assign::list_of("101")("P4tUNeYphUn8YW4dTQc2RtsbJPhywFJZvP8S")));
    BOOST_CHECK_EQUAL(result[0].get_int(), 101);
    BOOST_CHECK_EQUAL(result[1].get_str(), "P4tUNeYphUn8YW4dTQc2RtsbJPhywFJZvP8S");

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", boost::assign::list_of("101")("P4tLKrEMxWZWbcXmrkJ8oAkKhGCTwzcVBuVs")));
    BOOST_CHECK_EQUAL(result[0].get_int(), 101);
    BOOST_CHECK_EQUAL(result[1].get_str(), "P4tLKrEMxWZWbcXmrkJ8oAkKhGCTwzcVBuVs");

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", boost::assign::list_of("1")("P4taAaZbN8Sk1FKjedBbYuFSrwXV5KxuaWwV")("9")));
    BOOST_CHECK_EQUAL(result[0].get_int(), 1);
    BOOST_CHECK_EQUAL(result[1].get_str(), "P4taAaZbN8Sk1FKjedBbYuFSrwXV5KxuaWwV");
    BOOST_CHECK_EQUAL(result[2].get_int(), 9);

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", boost::assign::list_of("1")("P4tVuwQDqCo5M7wy1gVyYBcUybMdyUxgRNhB")("9")));
    BOOST_CHECK_EQUAL(result[0].get_int(), 1);
