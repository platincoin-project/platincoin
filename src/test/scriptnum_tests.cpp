...
{
    return bignum.getvch() == scriptnum.getvch() && bignum.get<int>() == scriptnum.get<int>();
}
...
static void CheckCreateInt(const int64_t& num)
{
    ...
    CScriptNum scriptnum(num);
    BOOST_CHECK(verify(bignum, scriptnum));
    BOOST_CHECK(verify(CScriptNum10(bignum.get<int>()), CScriptNum(scriptnum.get<int>())));
    BOOST_CHECK(verify(CScriptNum10(scriptnum.get<int>()), CScriptNum(bignum.get<int>())));
    BOOST_CHECK(verify(CScriptNum10(CScriptNum10(scriptnum.get<int>()).get<int>()), CScriptNum(CScriptNum(bignum.get<int>()).get<int>())));
}
