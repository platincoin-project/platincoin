...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s platincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  platincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded platincoin transaction") + "\n" +
              "  platincoin-tx [options] -create [commands]   " + _("Create hex-encoded platincoin transaction") + "\n" +
              "\n";
