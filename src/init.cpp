...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/platincoin-project/platincoin>";
    const std::string URL_WEBSITE = "<https://platincoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Platincoin version %s\n", FormatFullVersion());
}
